...
//    },
    ...
    newRow: function () {
        ...
        $.get('/invoice/product/invoice/user/api/', function (data, status) {
            $.each(data.products, function(key, result){
                console.log("_____________________cmg___________")
                console.log("_____________________cmg___________")
                console.log("_____________________cmg___________")
                console.log("_____________________cmg___________")
                console.log(result.expiry)
                item_list += '<option data-value="' + result.id + '" data-price="' + result.consumer_price + '" data-stock= "' + result.expiry +'" value="' + result.name  +'">' + result.name + '</option>'
            });
            item_list += '</datalist>';
